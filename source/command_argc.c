...
int parse_flags(int argc, char *argv[])
{
	...
	else
	{
		...
		{	
			...
			int returned_value = (*flag.program_t)(argv, current_index, argc);
...
int flag_names_comparison(const char *possible_flag, Flag_t flags[])
{
...
int print_help(char * argv[], int current_index_argv, int argc)
{
	...
	printf(RED "\nPossible flags to use:\n\n" RESET
			MAGENTA "\"-h\" or \"--help\" - provide information about usage of this program.\n\n"
